...
insert into
	alltrip(ride_id, rideable_type, started_at, ended_at, start_station_name, start_station_id, end_station_name, end_station_id, member_casual)
...
SELECT 
AVG(datediff(minute, started_at, ended_at)) as AverageTimeRidingTime
from alltrip


--Most 5 common starting/ending station and ending station of casual users
select top (5)
start_station_name,
count (*)
from alltrip
...
--Most 5 common starting/ending stations and ending stations of member users
select top (5)
start_station_name,
count (*)
from alltrip
...
--Busiest hour of the the day
SELECT count(ride_id),
DATENAME(hh, started_at)
from alltrip
where member_casual = 'casual'
